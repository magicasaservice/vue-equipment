...
```sh [pnpm]
pnpm install @floating-ui/vue @maas/vue-primitive @nuxt/kit @vueuse/core defu
```

```sh [npm]
npm install @floating-ui/vue @maas/vue-primitive @nuxt/kit @vueuse/core defu
```

```sh [yarn]
yarn add @floating-ui/vue @maas/vue-primitive @nuxt/kit @vueuse/core defu
```

```sh [bun]
bun install @floating-ui/vue @maas/vue-primitive @nuxt/kit @vueuse/core defu
```
