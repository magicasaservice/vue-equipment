<template>
  <magic-menu-provider id="magic-menu--menubar" class="w-full flex gap-4">
    <magic-menu-view>
      <magic-menu-trigger>Edit</magic-menu-trigger>
      <magic-menu-content>
    ...
    <magic-menu-view>
      <magic-menu-trigger>File</magic-menu-trigger>
      <magic-menu-content>
    ...
    <magic-menu-view>
      <magic-menu-trigger>View</magic-menu-trigger>
      <magic-menu-content>
    ...
    <magic-menu-view>
      <magic-menu-trigger>Profiles</magic-menu-trigger>
      <magic-menu-content>
        <magic-menu-item>
          <magic-menu-view>
  ...
  <magic-menu-provider id="magic-menu--dropdown">
    <magic-menu-view>
      <magic-menu-trigger>Open</magic-menu-trigger>
